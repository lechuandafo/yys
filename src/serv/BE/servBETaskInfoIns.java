...
public class servBETaskInfoIns extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public servBETaskInfoIns() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String Quate = request.getParameter("quate").trim();
		...
		voTaskInfo.setQuate(Integer.parseInt(Quate));
