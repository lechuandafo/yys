				...
				<div class="table-responsive col-xs-12">
				  <table class="table  bar-font" >
				    <caption class="text-center bar-titlefont">
				      ...
				      <tr>
				        <td class="bar-font2">
				        	<a href="#" data-toggle="modal" data-target="#Modal_sc" onclick="setFightTag(2)">壹层</a>
				        </td>
				      ...
				      <tr>
				        <td class="bar-font2">
				        	<a href="#" data-toggle="modal" data-target="#Modal_sc" onclick="setFightTag(2)">贰层</a>
				        </td>	
				      </tr>		
				      <tr>
				        <td class="bar-font2"> 
				        	<a href="#" data-toggle="modal" data-target="#Modal_sc" onclick="setFightTag(2)">叁层</a>
				        </td>	
				      </tr>	
				      <tr>
				        <td class="ts_bg1">
...
<div class="modal fade" id="Modal_jj" tabindex="-1" role="dialog" aria-hidden="true" >		
			...
			<div class="col-xs-offset-2 bar-center-vertical manner-bar2">
				...
				<div class="table-responsive  col-xs-12"  style="max-height:250px">
				  <table class="table  table-hover bar-font2" >
				    ...
				    <input name="fightTag" id="fightTag" type="hidden" value="1"/>	<!-- fightTag为1代表刷剧情副本，为2代表刷御魂副本 -->
				  </table>
				</div>
				<center>
	...
	<!-- /.yysmodal -->
	    <SCRIPT LANGUAGE="JavaScript">
			...
			function setFightTag(tag){
				document.getElementById("fightTag").value = tag;
			}
